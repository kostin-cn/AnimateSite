...
let coord_centerlat = coord.dataset.centerlat;
let coord_centerlng = coord.dataset.centerlng;
...
if (window.innerWidth < 960) {
    oz_center_map = new google.maps.LatLng(coord_lat,coord_lng);
}else {
    oz_center_map = new google.maps.LatLng(coord_centerlat,coord_centerlng);
}
...
function initialize() {
    ...
    const contentString = '<span class="map-marker">'+coord_title+'<span>';
    ...
    let marker = new google.maps.Marker({
        ...
        map: map,
        // icon: icon,
        icon: new google.maps.MarkerImage('files/map-marker.svg',
            null, null, null, new google.maps.Size(82,50)),
        title: coord_title
    });
