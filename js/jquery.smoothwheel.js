    ...
    var render = function () {
        if (vy < -(minMovement) || vy > minMovement) {
            ...
            if (container.hasClass('animated')) {
                ...
                if (container.parent().find('#indexSlider').length) {
                    ...
                    container.find('.slide').each(function () {
                        ...
                        if (curr > -innerWidth/20 && curr < innerWidth/20) {
                ...
                if (container.parent().find('#gallerySlider').length) {
                    imgMatrix(container);
                }
            }
        }
    ...
    $.fn.smoothWheel = function () {
        ...
        return this.each(function (index, elm) {
            ...
            if(!('ontouchstart' in window)){
                ...
                minScrollTop = container.get(0).clientWidth - container.get(0).scrollWidth;
                if(options.onRender){
